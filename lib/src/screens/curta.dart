...
class Curta extends StatefulWidget {
  Curta({Key key, this.title}) : super(key: key);


  final String title;

  @override
  _CurtaState createState() => _CurtaState();
}

class _CurtaState extends State<Curta> {
          ...
          //-----------------------------------------------------------/////////
              ...
              child: Column(
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      Text("Curta São Paulo", style: TextStyle(fontSize: 20),)
                    ],
                  ),

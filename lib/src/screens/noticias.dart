...
class Noticias extends StatefulWidget {
  Noticias({Key key, this.title}) : super(key: key);
          ...
          //-----------------------------------------------------------/////////
              ...
              child: Column(
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      Text("Notícias", style: TextStyle(fontSize: 20),)
                    ],
                  ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.all(Radius.circular(10.0)),
                              ...
                              image:  DecorationImage(image: NetworkImage('https://www.guiagaysaopaulo.com.br/public/uploads/imagens/originais/parada_lgbt_gay_canceladas_adiadas_coronavirus.jpg'),
                              fit: BoxFit.cover
                              )
                            ...
                            child: imageData('Notícia Principal 1'),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.all(Radius.circular(10.0)),
                              ...
                              image:  DecorationImage(image: NetworkImage('https://www.guiagaysaopaulo.com.br/public/uploads/imagens/originais/felipe_accioly_clipe_beach_boy_top_30_gay_brasil_dj.jpg'),
                              fit: BoxFit.cover
                              )
